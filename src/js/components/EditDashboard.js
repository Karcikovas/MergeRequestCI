        ...
        <div id="edit-dashboard" className="container">
            ...
            <div className="content">
                <div>
                    <h2>General</h2>
                    <div>
                        <label htmlFor="boardTitle">Dashboard Title</label>
                    </div>
                    <input
                        type="text"
                        id="boardTitle"
                ...
                <div>
                    <h2>Comments</h2>
                    <p>
                        Specify comments in the GitHub emoji format, e.g.{' '}
                        <code>:+1:</code>
                        or <code>:cactus:</code>.
                    </p>
                    For a full list, see{' '}
                ...
                <div>
                    ...
                    <div>
                        <label htmlFor="positiveMerge">
                            Minimum Positive Comments
                        </label>
                    </div>
                    <input
                        type="number"
                        id="positiveMerge"
                        value={this.state.config.mergeRule.positive}
                        onChange={this.handleChangePositiveMergeRule}
                    />

                    <div>
                        <label htmlFor="negativeMerge">
                            Maximum Negative Comments
                        </label>
                    </div>
                    <input
                        type="number"
                        id="negativeMerge"
                        value={this.state.config.mergeRule.negative}
                        onChange={this.handleChangeNegativeMergeRule}
                    />

                    <div>
                        <label htmlFor="staleHours">
                            Hours Till PR is Stale
                        </label>
                    </div>
                    <input
                        type="number"
                        id="staleHours"
                        value={this.state.config.mergeRule.staleHours}
                        onChange={this.handleChangeStaleHours}
                    />

                    <div>
                        <label htmlFor="neverMerge">Never merge regexp</label>
                    </div>
                    <input
                        type="text"
                        id="neverMerge"
                        value={this.state.config.mergeRule.neverRegexp}
