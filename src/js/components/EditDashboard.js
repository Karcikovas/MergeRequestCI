      ...
      <div id="edit-dashboard" className="container">
        ...
        <div className="content">
          ...
          <div>
            ...
            <div>
              <label htmlFor="positiveMerge">Minimum Positive Comments</label>
            </div>
            <input
              type="number"
              id="positiveMerge"
            ...
            <div>
              <label htmlFor="negativeMerge">Maximum Negative Comments</label>
            </div>
            <input
              type="number"
              id="negativeMerge"
            ...
            <div>
              <label htmlFor="staleHours">Hours Till PR is Stale</label>
            </div>
            <input
              type="number"
              id="staleHours"
